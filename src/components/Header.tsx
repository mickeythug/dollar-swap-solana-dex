    ...
    <header className="relative z-10 px-2 sm:px-4 py-3 sm:py-6">
      ...
      <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between space-y-4 sm:space-y-0">
        <div className="flex items-center space-x-2 sm:space-x-3">
          ...
          <div className="bg-yellow-300 p-2 sm:p-3 lg:p-4 rounded-xl sm:rounded-2xl border-3 sm:border-4 lg:border-6 border-black border-dashed" style={{
        ...
        <div className="flex items-center space-x-2 sm:space-x-4">
          <div className="hidden md:flex items-center space-x-3 lg:space-x-6">
            <a href="#swap" className="bg-yellow-300 px-3 sm:px-4 lg:px-6 py-2 sm:py-2 lg:py-3 rounded-lg sm:rounded-xl border-3 sm:border-4 border-black shadow-lg" style={{
              boxShadow: '3px 3px 0px #000000',
              fontFamily: '"Trebuchet MS", Arial, sans-serif'
            }}>
              <span className="text-green-900 font-black text-sm sm:text-lg lg:text-xl">SWAP!</span>
            </a>
            <a href="#about" className="bg-green-400 px-3 sm:px-4 lg:px-6 py-2 sm:py-2 lg:py-3 rounded-lg sm:rounded-xl border-3 sm:border-4 border-black shadow-lg" style={{
              boxShadow: '3px 3px 0px #000000',
              fontFamily: '"Trebuchet MS", Arial, sans-serif'
            }}>
          ...
          <div>
            <WalletMultiButton className="!bg-yellow-400 hover:!bg-yellow-500 !border-3 sm:!border-4 lg:!border-6 !border-black !rounded-lg sm:!rounded-xl lg:!rounded-2xl !font-black !px-3 sm:!px-6 lg:!px-8 !py-2 sm:!py-3 lg:!py-4 !text-sm sm:!text-lg lg:!text-xl !text-green-900 !shadow-lg" style={{
              fontFamily: '"Trebuchet MS", Arial, sans-serif',
              boxShadow: '3px 3px 0px #000000'
            }} />
          </div>
