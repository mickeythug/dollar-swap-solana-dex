...
const MobileSwapInterface = () => {
  ...
  return (
    <div className="px-4 py-6">
      {/* Header - mobile-friendly font */}
      <div className="mb-6 text-center">
        <div className="inline-block">
          <h2 className="text-2xl font-black text-black mb-3 bg-yellow-400 px-4 py-2 rounded-2xl border-4 border-black brutal-shadow-lg transform rotate-1" style={{
            letterSpacing: '2px'
          }}>
            Quick Swap
          </h2>
        </div>
        <p className="text-white text-base mt-4 font-black px-2">
      ...
      <div className="meme-card p-4 rounded-3xl brutal-shadow-xl mb-6 transform rotate-1 transition-bounce hover:scale-105 hover:-rotate-1 max-w-sm mx-auto">
        {/* From section - mobile-friendly font */}
        <div className="mb-4">
          <div className="flex justify-between items-center mb-2">
            <span className="text-black font-black text-sm">From</span>
            <span className="text-black/70 text-xs font-black">Balance: 0.0</span>
          </div>
          ...
          <div className="bg-green-100 rounded-2xl p-3 border-4 border-black brutal-shadow transform -rotate-1">
            <div className="flex items-center gap-2">
              ...
              <input
                ...
                className="flex-1 bg-transparent text-black text-lg font-black outline-none placeholder-black/50 min-w-0"
              />
            </div>
          </div>
        </div>
        ...
        {/* To section - mobile-friendly font */}
        <div className="mb-4">
          <div className="flex justify-between items-center mb-2">
            <span className="text-black font-black text-sm">To</span>
            <span className="text-black/70 text-xs font-black">Balance: 0.0</span>
          </div>
        ...
        {/* Swap button - mobile-friendly font */}
        <Button className="w-full bg-yellow-400 hover:bg-yellow-500 text-black font-black text-base py-4 rounded-2xl border-4 border-black brutal-shadow-lg hover:scale-105 transition-bounce transform -rotate-1 hover:rotate-1" style={{
          letterSpacing: '1px'
        }}>
      ...
      {/* Quick actions - mobile-friendly font */}
      <div className="grid grid-cols-2 gap-3 mb-6 max-w-sm mx-auto">
        <button className="bg-green-600 hover:bg-green-700 border-4 border-black rounded-2xl p-3 flex flex-col items-center gap-2 brutal-shadow transition-bounce hover:scale-105 transform rotate-1 hover:-rotate-1">
          ...
          <span className="text-white text-xs font-black">Price Chart</span>
        </button>
        ...
        <button className="bg-purple-600 hover:bg-purple-700 border-4 border-black rounded-2xl p-3 flex flex-col items-center gap-2 brutal-shadow transition-bounce hover:scale-105 transform -rotate-1 hover:rotate-1">
          ...
          <span className="text-white text-xs font-black">Settings</span>
        </button>
      </div>

      {/* Market info - mobile-friendly font */}
      <div className="meme-card p-4 rounded-2xl brutal-shadow transform rotate-1 max-w-sm mx-auto">
        <h3 className="text-black font-black mb-3 text-center text-base" style={{
          letterSpacing: '1px'
        }}>Market Stats</h3>
        <div className="space-y-2">
          <div className="flex justify-between bg-white/20 p-2 rounded-lg border-2 border-black/20">
            <span className="text-black font-black text-xs">Price</span>
            <span className="text-green-600 text-xs font-black">$0.00001</span>
          </div>
          <div className="flex justify-between bg-white/20 p-2 rounded-lg border-2 border-black/20">
            <span className="text-black font-black text-xs">24h Change</span>
            <span className="text-green-600 text-xs font-black">+12.5%</span>
          </div>
          <div className="flex justify-between bg-white/20 p-2 rounded-lg border-2 border-black/20">
            <span className="text-black font-black text-xs">Market Cap</span>
            <span className="text-black text-xs font-black">$1.2M</span>
          </div>
        </div>
      </div>
    </div>
