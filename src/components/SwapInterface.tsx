  ...
  return (
    <div className="max-w-md mx-auto w-full animate-slide-up">
      ...
      <div className="mt-8 w-full">
        <div className="bg-yellow-400 hover:bg-yellow-500 rounded-2xl border-6 border-black p-6 sm:p-8 lg:p-10 transform rotate-1 brutal-shadow-xl transition-bounce hover:scale-105 hover:-rotate-1 overflow-hidden w-full max-w-6xl mx-auto">
