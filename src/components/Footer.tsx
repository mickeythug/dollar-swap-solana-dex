...
const Footer = () => {
  return (
    <footer className="relative z-10 px-2 sm:px-4 lg:px-8 py-8 sm:py-12 mt-8 sm:mt-16">
                ...
                <div className="space-y-2 sm:space-y-3 lg:space-y-4">
                  {[
                    ...
                    <a 
                      key={index}
                      href="#" 
                      className="block meme-card p-2 sm:p-3 lg:p-4 rounded-lg sm:rounded-xl border-3 sm:border-4 border-black border-dashed brutal-shadow transition-bounce hover:scale-110 hover:rotate-3"
                      style={{
