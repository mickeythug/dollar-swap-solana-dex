    ...
    <section className="relative z-10 px-2 sm:px-4 py-8 sm:py-12 lg:py-16 text-center">
      <div className="max-w-4xl mx-auto">
        <div className="mb-6 sm:mb-8">
          ...
          <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl font-black text-yellow-400 mb-4 sm:mb-6 lg:mb-8 leading-tight" style={{
            fontFamily: '"Trebuchet MS", Arial, sans-serif',
          ...
          <div className="bg-green-400 p-4 sm:p-6 lg:p-8 rounded-2xl sm:rounded-3xl border-4 sm:border-6 border-black border-dashed shadow-xl sm:shadow-2xl max-w-4xl mx-auto" style={{
            ...
            <div className="bg-yellow-300 p-3 sm:p-4 lg:p-6 rounded-xl sm:rounded-2xl border-3 sm:border-4 border-black border-dashed inline-block" style={{
        ...
        <div className="flex flex-col items-center space-y-6 sm:space-y-8">
          ...
          <div className="flex items-center text-yellow-400" style={{
